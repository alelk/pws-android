...
enum class SongRefReason(val identifier: String) {
  ...
  companion object {
    fun fromIdentifier(identifier: String) =
      checkNotNull(entries.firstOrNull { it.identifier == identifier }) { "unknown ${io.github.alelk.pws.database.entity.SongRefReason::class.simpleName} identifier: $identifier" }
  }
}
...
@Entity(
  ...
  foreignKeys = [
    ForeignKey(entity = io.github.alelk.pws.database.entity.SongEntity::class, parentColumns = ["_id"], childColumns = ["psalmid"], onDelete = ForeignKey.CASCADE),
    ForeignKey(entity = io.github.alelk.pws.database.entity.SongEntity::class, parentColumns = ["_id"], childColumns = ["refpsalmid"], onDelete = ForeignKey.CASCADE)
  ],
  indices = [
...
data class SongSongReferenceEntity(
    ...
    @ColumnInfo(name = "reason") val reason: io.github.alelk.pws.database.entity.SongRefReason,
